            ...
            <div className='red_box'>
                <div className='container grid'>
                    <h3 className='title'>Simandhar Learn App ( LMS ) is Available
                        on all Platforms</h3>
                    <div>
                        <a href="https://apps.apple.com/us/app/simandhar-learn/id1628605439" target="_blank" rel="noopener noreferrer"> <Image src="/img/app_store_1.png" alt="apple store" layout="fill" className='resp-img'/></a>
                        <a href="https://play.google.com/store/apps/details?id=com.horizzon.simandhareducation&hl=en_IN&gl=US&pli=1" target="_blank" rel="noopener noreferrer"> <Image src="/img/app_store_2.png" alt="apple store" layout="fill" className='resp-img'/></a>
                    </div>
                </div>
            </div>
        </>
